...
struct Collections: Codable {
    ...
    let user: User?
    let coverPhoto: WelcomeCoverPhoto?
...
// MARK: - WelcomeCoverPhoto
struct WelcomeCoverPhoto: Codable {
    let id, slug: String?
    ...
    let color: String?
    let blurHash, description: String?
...
class JSONNull: Codable, Hashable {
    ...
    func hash(into hasher: inout Hasher) {
        hasher.combine(0) // Replace 'id' with a unique property of your struct
    }
